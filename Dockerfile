...
COPY index.html about.html donate.html contact.html supporters.html thank-you.html gift-aid.html portal.html privacy.html admin.html my-story.html hub.html set-password.html _redirects ./
COPY assets ./assets
EXPOSE 3000
USER node
