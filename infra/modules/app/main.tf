...
# From/Reply-To address for admin thank-you letters (TASK-165/REQ-069). NOT a secret (it ships in
# the email headers), but SSM-held and injected like NEWSLETTER_FROM_EMAIL so it varies per
# environment. A plain String; the value is the real production giving address.
